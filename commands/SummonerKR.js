...
module.exports = {
    ...
    async execute(message, args) {
        ...
        try {
            ...
            const { accountId, name, id } = await fetch(`https://kr.api.riotgames.com/lol/summoner/v4/summoners/by-name/${inName}?api_key=${RIOTAPIKEY}`).then(response => response.json());
